...
contract EscrowFactoryTest is Test {
    ...
    function setUp() public {
        ...
        factory = new EscrowFactory(token, factoryOwner, oracle);
    }
    ...
    function test_Revert_ConstructorTokenNol() public {
        vm.expectRevert(EscrowFactory.AlamatNol.selector);
        new EscrowFactory(IERC20(address(0)), factoryOwner, oracle);
    }

    function test_Revert_ConstructorOracleNol() public {
        vm.expectRevert(EscrowFactory.AlamatNol.selector);
        new EscrowFactory(token, factoryOwner, address(0));
    }
