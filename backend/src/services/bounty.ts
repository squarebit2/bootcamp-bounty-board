...
import { bountyEscrowAbi, escrowFactoryAbi, rewardTokenAbi, statusLabel } from "../contracts";
...
export const board = async () => ({
  total: Number(await client.readContract({
    address: CONTRACTS.escrowFactory, abi: escrowFactoryAbi, functionName: "totalBounties",
  })),
  ...getBoard(),
});
